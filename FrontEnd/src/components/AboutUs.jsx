  ...
  return (
    <div className="about-us-container">
      ...
      <div id="legal-section" className="legal-section">
        ...
        <h3>Terms of Use</h3>
        <p>
          These Terms govern your access to and use of The Great Bazaar's
          services, including our website, mobile applications, and e-commerce
          platform. By accessing or using our services, you agree to be bound by
          these Terms, which include limitations on our liability and
          obligations related to the use of our service. You are responsible for
          your conduct on the platform and compliance with all applicable laws.
          Content on our platform should not be copied, reproduced, or used in
          violation of intellectual property rights or other laws.
        </p>
        <h3>Privacy Policy</h3>
        <p>
          Your privacy is paramount at The Great Bazaar. This policy provides
          details on the information we collect, including personal and payment
          details, how we use it to enhance your shopping experience, and the
          measures we take to protect your information. We do not share your
          personal details with third parties without your consent, except as
          necessary to provide our services or comply with the law.
        </p>
        <h3>Cookie Policy</h3>
        <p>
          Our website uses cookies to enhance your user experience, allowing us
          to remember your preferences and provide personalized service. We
          detail the types of cookies used and their purposes. You have the
          option to manage cookie preferences through your browser settings.
        </p>
        <h3>Disclaimer</h3>
        <p>
          The Great Bazaar provides its services on an "as is" basis and does
          not guarantee the accuracy, completeness, or timeliness of information
          available on our platform. We are not liable for any inaccuracies or
        ...
        <div className="contact-info">
          ...
          <p>
            For any legal inquiries or concerns regarding The Great Bazaar's
            services, please contact us at: <br />
            Email: GreatBazzar@gmail.com
            <br />
            Phone: 052-627-8585
            <br />
            Address: 1234 Legal Street, City, Country
          </p>
        </div>
      </div>
    </div>
